...
class MyNode
{
  ...
  public: 
    ...
    MyNode() : ac("/position_joint_trajectory_controller/follow_joint_trajectory", true)
    {
        ...
        //q0=*msg;*/
        q0.position={-0.046482558179842794, -0.34113309193494024, -0.007584855000047307, -1.752088473972521, -0.012323863322536252, 1.5533312192228106, 2.6412585185767594};
    ...
    /*void timerCallback(const ros::TimerEvent&)
    {
        ...
        ros::Duration iniziale(0,0);
        ros::Duration finale(0.02,0); //il goal deve essere raggiunto in 15 ms
        goal.goal.trajectory.points[0].time_from_start=finale;
